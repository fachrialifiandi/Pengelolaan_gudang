        ...
        while (Menu != 0):
            ...
            match (Menu):
                ...
                case 2:
                    ...
                    N = TambahBarang(Kode, Nama, Jumlah, Satuan, N,
                                     KodeBaru, NamaBaru, JumlahBaru, SatuanBaru)
                ...
                case 4:
                    if (N == 0):
                        ...
                        print()
                        ElemenHapus = input(
                            'Masukkan kode barang yang akan dikeluarkan: ').upper()
                        N = HapusBarang(Kode, Nama, Jumlah,
                                        Satuan, N, ElemenHapus)
                ...
                case 7:
                    ...
                    MenghapusSemuaBarangData(
                        Kode, Nama, Jumlah, Satuan, N, KodeBaru, NamaBaru, JumlahBaru, SatuanBaru)
